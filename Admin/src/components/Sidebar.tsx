...
const NAV_ITEMS: NavItem[] = [
    ...
    { id: 'subheadings', label: 'SubHeadings', icon: <List size={16} /> },
    ...
    { id: 'ad-inquiry', label: 'Ad Inquiry', icon: <DollarSign size={16} /> },
    { id: 'jobs', label: 'Jobs', icon: <Briefcase size={16} /> },
    { id: 'job-applicants', label: 'Job Applicants', icon: <UserCheck size={16} /> },
