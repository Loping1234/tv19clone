                            ...
                            <>
                                ...
                                {heroArticle && (
                                    <a href={heroArticle.url} target="_blank" rel="noopener noreferrer" className="lifestyle-hero-card">
                                        <div className="lifestyle-hero-card__image-wrap">
                                            <NewsImage 
                                                src={heroArticle.image} 
                                                alt={heroArticle.title} 
                                                category="lifestyle"
                                                articleUrl={heroArticle.url}
                                                className="lifestyle-hero-card__image"
                                            />
                                ...
                                <div className="lifestyle-story-list">
                                    {mainListArticles.map((article, index) => (
                                        <a key={`${article.title}-${index}`} href={article.url} target="_blank" rel="noopener noreferrer" className="lifestyle-story-item">
                                            <div className="lifestyle-story-item__thumb-wrap">
                                                <NewsImage 
                                                    src={article.image} 
                                                    alt={article.title} 
                                                    category="lifestyle"
                                                    articleUrl={article.url}
                                                    className="lifestyle-story-item__thumb"
                                                />
                                            </div>
                                    ...
                                    {trendingArticles.map((article, idx) => (
                                        idx === 0 ? (
                                            <a key={idx} href={article.url} className="lifestyle-trending-item-top" target="_blank" rel="noopener noreferrer">
                                                <div className="lifestyle-trending-item-top__image-wrap">
                                                    <NewsImage 
                                                        src={article.image} 
                                                        alt={article.title} 
                                                        category="lifestyle"
                                                        articleUrl={article.url}
                                                        className="lifestyle-trending-item-top__image"
                                                    />
                                                </div>
                                            ...
                                            <a key={idx} href={article.url} className="lifestyle-trending-item-small" target="_blank" rel="noopener noreferrer">
                                                <div className="lifestyle-trending-item-small__image-wrap">
                                                    <NewsImage 
                                                        src={article.image} 
                                                        alt={article.title} 
                                                        category="lifestyle"
                                                        articleUrl={article.url}
                                                        className="lifestyle-trending-item-small__image"
                                                    />
                                                </div>
                                                <div>
                                                    <span className="lifestyle-trending-rank">#{idx + 1} Trending</span>
