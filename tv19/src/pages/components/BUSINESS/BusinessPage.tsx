                            ...
                            <>
                                ...
                                {heroArticle && (
                                    <a href={heroArticle.url} target="_blank" rel="noopener noreferrer" className="business-hero-card">
                                        <div className="business-hero-card__image-wrap">
                                            <NewsImage 
                                                src={heroArticle.image} 
                                                alt={heroArticle.title} 
                                                category="business"
                                                articleUrl={heroArticle.url}
                                                className="business-hero-card__image"
                                            />
                                ...
                                <div className="business-story-list">
                                    {mainListArticles.map((article, index) => (
                                        <a key={`${article.title}-${index}`} href={article.url} target="_blank" rel="noopener noreferrer" className="business-story-item">
                                            <div className="business-story-item__thumb-wrap">
                                                <NewsImage 
                                                    src={article.image} 
                                                    alt={article.title} 
                                                    category="business"
                                                    articleUrl={article.url}
                                                    className="business-story-item__thumb"
                                                />
                                            </div>
                                    ...
                                    {trendingArticles.map((article, idx) => (
                                        idx === 0 ? (
                                            <a key={idx} href={article.url} className="business-trending-item-top" target="_blank" rel="noopener noreferrer">
                                                <div className="business-trending-item-top__image-wrap">
                                                    <NewsImage 
                                                        src={article.image} 
                                                        alt={article.title} 
                                                        category="business"
                                                        articleUrl={article.url}
                                                        className="business-trending-item-top__image"
                                                    />
                                                </div>
                                            ...
                                            <a key={idx} href={article.url} className="business-trending-item-small" target="_blank" rel="noopener noreferrer">
                                                <div className="business-trending-item-small__image-wrap">
                                                    <NewsImage 
                                                        src={article.image} 
                                                        alt={article.title} 
                                                        category="business"
                                                        articleUrl={article.url}
                                                        className="business-trending-item-small__image"
                                                    />
                                                </div>
                                                <div>
                                                    <span className="business-trending-rank">#{idx + 1} Trending</span>
