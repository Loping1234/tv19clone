    ...
    return (
        <main className="technology-region-page">
            <section className="technology-region-shell">
                <div className="technology-subnav-wrapper">
                    <button className="technology-nav-btn prev" aria-label="Scroll left" onClick={() => scroll('left')}><UilAngleLeft /></button>
                    <div className="technology-subnav" role="tablist" aria-label="Technology regions" ref={scrollRef}>
                        {REGIONS.map((region) => (
                            <button
                                key={region}
                                type="button"
                                ...
                                className={`technology-subnav__item ${activeRegion === region ? 'active' : ''}`}
                    ...
                    <button className="technology-nav-btn next" aria-label="Scroll right" onClick={() => scroll('right')}><UilAngleRight /></button>
                </div>
