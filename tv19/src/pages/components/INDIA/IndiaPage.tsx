    ...
    return (
        <main className="india-region-page">
            <section className="india-region-shell">
                <div className="india-subnav-wrapper">
                    <button className="india-nav-btn prev" aria-label="Scroll left" onClick={() => scroll('left')}><UilAngleLeft /></button>
                    <div className="india-subnav" role="tablist" aria-label="India regions" ref={scrollRef}>
                        {REGIONS.map((region) => (
                            <button
                                key={region}
                                type="button"
                                ...
                                className={`india-subnav__item ${activeRegion === region ? 'active' : ''}`}
                    ...
                    <button className="india-nav-btn next" aria-label="Scroll right" onClick={() => scroll('right')}><UilAngleRight /></button>
                </div>
